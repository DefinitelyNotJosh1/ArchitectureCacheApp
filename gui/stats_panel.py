"""
Statistics Panel for Cache Learning Application
Displays hit/miss statistics
"""
...
class StatsPanel(QWidget):
    """Panel for displaying cache statistics"""
    ...
    def init_ui(self):
        ...
        self.hits_label.setAlignment(Qt.AlignmentFlag.AlignLeft)
        stats_layout.addWidget(self.hits_label)
        
        # Miss counter
        self.misses_label = QLabel("Misses: 0")
        self.misses_label.setAlignment(Qt.AlignmentFlag.AlignLeft)
        stats_layout.addWidget(self.misses_label)
        
        # Hit rate
        self.hit_rate_label = QLabel("Hit Rate: 0.0%")
        self.hit_rate_label.setAlignment(Qt.AlignmentFlag.AlignLeft)
